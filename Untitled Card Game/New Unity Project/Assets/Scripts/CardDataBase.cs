...
public class CardDataBase : MonoBehaviour
{
    ...
    void Awake ()
    {
        ...
        cardList.Add(new Cards(1, "Card1", 45, 1, 5, "Grounded(60):Increase this cards damage by 5.\nDeal 5 damage", new Vector2(0, 3)));//GROUND(X):the effect takes place once every X event seconds, while the card is in hand.
        ...
        cardList.Add(new Cards(8, "Card8", 0, 1, 10, "Event(60):Ignite. The Enemy takes 10 damage", new Vector2(3, 3)));
    }
